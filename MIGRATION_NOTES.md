...
3. Staff page new/edit shows Icon with a live preview. New pages start from the selected section’s icon; you can clear or override it. Changing Section updates the icon when it still matches the previous section default.
