...
class RecordingStudioSupportTest < ActiveSupport::TestCase
  ...
  test "dummy seeds use hierarchy idempotently and restore current actor" do
    ...
    support_page = RecordingStudioSupport::SupportPage.find_by!(title: "How do I sign in?")
    ...
    support_page_recording = RecordingStudio::Recording.find_by!(recordable: support_page)
    ...
    assert_operator RecordingStudioSupport::SupportPage.count, :>=, 1
