...
class PagesTest < Minitest::Test
  ...
  def test_index_view_uses_flatpack_search
    ...
    assert_includes search, "local_assigns[:prominent]"
    assert_includes search, "--search-padding-y-lg: 1.125rem"
    refute_includes search, "[&_input]:py-3.5"
    assert_includes public_index, "size: :lg"
    assert_includes public_index, "prominent: true"
    assert_includes public_index, "text-center"
  ...
  def test_section_and_page_lists_wrap_list_in_card
    ...
    assert_includes public_index, "cols: 3"
    refute_includes public_index, "cols: 1"
    ...
    assert_includes article_cards, "gap-10"
  ...
  def test_public_show_is_a_simple_article
    ...
    assert_includes body_helper, "support_body_image"
    assert_includes body_helper, "content_tag(:figure"
