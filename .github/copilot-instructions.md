...
- Keep changes small and scoped. This slice has no public pages, admin, search, or API.
...
- Cover Support page declaration, root rejection, and parent rejection in Minitest.
