...
module RecordingStudioSupport
  module Generators
    # Generator to install RecordingStudioSupport migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_support:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioSupport migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioSupport engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_support_pages.rb")
